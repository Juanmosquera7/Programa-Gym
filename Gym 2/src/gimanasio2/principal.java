...
public class principal{
    ...
    public void reservarClase(String cedula, String idClase) throws Exception{
        ...
        if(clase == null){
            throw new Exception("Clase con ID" + idClase + " No encontrada.");
        }
        //Se agrega el usuario a la lista de inscritos de la clase
        clase.getInscritos().add(usuario);
        System.out.println("Clase " + clase.getNombre() + " Reservada exitosamente para el usuario con cédula " + cedula + ".");
    }
